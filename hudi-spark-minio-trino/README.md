...
* [Comparing Apache Hudi's MOR (read and write balanaced workload pattern) and COW Tables (read heavy workload pattern)](https://www.onehouse.ai/blog/comparing-apache-hudis-mor-and-cow-tables-use-cases-from-uber-and-shopee)
